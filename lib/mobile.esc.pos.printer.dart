...
class NetworkPrinter {
  ...
  Future<PosPrintResult> connect(String host,
    ...
    try {
      ...
      mw.debugPrint('>>>>>> Socket connected. ${_socket.hashCode}');
      mw.debugPrint('>>>>>> Socket connected. ${_socket.address}');
      mw.debugPrint('>>>>>> Socket connected. ${_socket.port}');
      mw.debugPrint('>>>>>> Socket connected. ${_socket.remoteAddress}');
      mw.debugPrint('>>>>>> Socket connected. ${_socket.remotePort}');
      mw.debugPrint('>>>>>> Socket connected. ${_socket.isBroadcast}');
